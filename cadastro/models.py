...
class ONG(models.Model):
    ...
    area_atuacao = models.CharField(
        max_length=150, verbose_name="Área de Atuação")
    contato = models.CharField(
        max_length=100, help_text="E-mail ou telefone principal")
...
class Selo(models.Model):
    ong = models.ForeignKey(
        ONG, on_delete=models.CASCADE, related_name="selos")
    avaliacao_origem = models.OneToOneField(
        Avaliacao, on_delete=models.PROTECT, null=True)
